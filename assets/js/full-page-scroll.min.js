...
! function (e, t, n, o, r) {
    ...
    function $n(e, t, n) {
        var o;
        n = void 0 === n ? {} : n, "function" == typeof zt.CustomEvent ? o = new CustomEvent(t, {
            detail: n
        }) : (o = jt.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, n), e.dispatchEvent(o)
    }
    ...
    return zt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (e, t) {
        ...
        function (e, E) {
            ...
            if (!Ln(u, Ft)) {
                ...
                p.k = En({}, p.m);
                var m, l, S, b, w, O, M, y, C, H = zt.PointerEvent ? {
                        down: "pointerdown",
                        move: "pointermove"
                    } : {
                        down: "MSPointerDown",
                ...
                Ct(), zt.fp_easings = En(zt.fp_easings, {
                ...
                }), d && (g.version = "3.1.0", g.setAutoScrolling = Z, g.setRecordHistory = ee, g.setScrollingSpeed = te, g.setFitToSection = ne, g.setLockAnchors = function (e) {
                    E.lockAnchors = e
                    ...
                    Z(!1, "internal"), re(!0), ie(!1), le(!1), Nn(d, Yt), [w, b, l, O, M, C, S, P].forEach(function (e) {
                        clearTimeout(e)
                    ...
                    for (var e = yn(qt), t = 0; t < e.length; t++) {
                        var n = t,
                            ...
                            r = yn(ln, o),
                            i = r.length;
                        o.setAttribute("data-fp-styles", o.getAttribute("style")), s = o, (c = n) || null != yn(Qt)[0] || Nn(s, Xt), f = yn(Qt)[0], Tn(s, {
                            height: A + "px"
                        }), E.paddingTop && Tn(s, {
                            "padding-top": E.paddingTop
                        }), E.paddingBottom && Tn(s, {
                            "padding-bottom": E.paddingBottom
                        }), void 0 !== E.sectionsColor[c] && Tn(s, {
                            "background-color": E.sectionsColor[c]
                        }), void 0 !== E.anchors[c] && s.setAttribute("data-anchor", E.anchors[c]), l = o, a = n, void 0 !== E.anchors[a] && Ln(l, Xt) && dt(E.anchors[a], a), E.menu && E.css3 && null != Wn(yn(E.menu)[0], Dt) && yn(E.menu).forEach(function (e) {
                            L.appendChild(e)
                        }), 0 < i ? we(o, r, i) : E.verticalCentered && pt(o)
                    }
                    var l, a, s, c;
                    ...
                    for (var e = 1; e < 4; e++) C = setTimeout(be, 350 * e)
                ...
                e ? (oe(!0), function () {
                    if (o || r) {
                        E.autoScrolling && (L.removeEventListener(I.touchmove, Te, {
                            passive: !1
                        }), L.addEventListener(I.touchmove, Te, {
                            passive: !1
                        }));
                        var e = E.touchWrapper;
                        e.removeEventListener(I.touchstart, Me), e.removeEventListener(I.touchmove, ke, {
                            passive: !1
                        }), e.addEventListener(I.touchstart, Me), e.addEventListener(I.touchmove, ke, {
                            passive: !1
                        })
                    }
                }()) : (oe(!1), function () {
                    if (o || r) {
                        E.autoScrolling && (L.removeEventListener(I.touchmove, ke, {
                            passive: !1
                        }), L.removeEventListener(I.touchmove, Te, {
                            passive: !1
                        }));
                        var e = E.touchWrapper;
                        e.removeEventListener(I.touchstart, Me), e.removeEventListener(I.touchmove, ke, {
            ...
            function we(e, t, n) {
                ...
                s.className = un, Pn(t, s), Tn(yn(fn, e), {
                    width: o + "%"
                }), 1 < n && (E.controlArrows && (l = e, a = [Gn('<div class="fp-controlArrow fp-prev"></div>'), Gn('<div class="fp-controlArrow fp-next"></div>')], Yn(yn(cn, l)[0], a), "#fff" !== E.controlArrowColor && (Tn(yn(bn, l), {
                ...
                })), E.loopHorizontal || Bn(yn(Sn, l))), E.slidesNavigation && function (e, t) {
            ...
            function Le() {
                ...
                if (!T && (!E.autoScrolling || E.scrollBar)) {
                    ...
                    if (t = a, n = yn(Qt)[0].offsetTop, o = n + xn(), ("up" != t ? n <= Un() : o >= Un() + xn()) && (Ln(yn(Qt)[0], _t) || (Nn(yn(Qt)[0], _t), zn(Xn(yn(Qt)[0]), _t))), !Ln(e = f[s], Xt)) {
                        ...
                        w && (p = w.getAttribute("data-anchor"), v = In(w)), k && (Nn(e, Xt), zn(Xn(e), Xt), _n(E.onLeave) && Ne("onLeave", y), _n(E.afterLoad) && Ne("afterLoad", y), Ke(h), Ye(e), Ue(e), dt(S, b - 1), E.anchors.length && (x = S), wt(v, p, S)), clearTimeout(O), O = setTimeout(function () {
                            F = !1
                        }, 100)
                    }
                        ...
                        E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d).isMovementUp ? Fn(yn(Qt)[0], Zn(p.activeSection, qt)) : Yn(yn(Qt)[0], eo(p.activeSection, qt).reverse()), Tt(yn(Qt)[0].offsetTop), Be(), p.wrapAroundElements = p.activeSection, p.dtop = p.element.offsetTop, p.yMovement = vt(p.element), d = p), d.localIsResizing || Ke(d.activeSection), E.scrollOverflow && E.scrollOverflowHandler.beforeLeave(), Nn(e, Xt), zn(Xn(e), Xt), Ye(e), E.scrollOverflow && E.scrollOverflowHandler.onLeave(), k = g.test.isTesting, wt(f, u, d.anchorLink, d.sectionIndex),
                            function (e) {
                                ...
                                if (E.css3 && E.autoScrolling && !E.scrollBar) {
                                    ...
                                    gt(o, !0), E.scrollingSpeed ? (clearTimeout(b), b = setTimeout(function () {
                                        De(e), k = !t
                                    }, E.scrollingSpeed)) : De(e)
                                } else {
                                    var r = Pe(e.dtop);
                                    g.test.top = -e.dtop + "px", Tn(h, {
            ...
            function it(e, t, n) {
                ...
                l.xMovement = (o = l.prevSlideIndex, r = l.slideIndex, o == r ? "none" : r < o ? "left" : "right"), l.direction = l.direction ? l.direction : l.xMovement, l.localIsResizing || (k = !1), E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && _n(E.onSlideLeave) && !1 === Ne("onSlideLeave", l) ? a = !1 : (Nn(t, Xt), zn(Xn(t), Xt), l.localIsResizing || (Ke(l.prevSlide), Ye(t)), !E.loopHorizontal && E.controlArrows && (Qn(yn(Sn, i), 0 !== l.slideIndex), Qn(yn(bn, i), null != Cn(t))), Ln(i, Xt) && !l.localIsResizing && wt(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex), function (e, t, n) {
                    ...
                    if (E.css3) {
                        ...
                        g.test.translate3dH[t.sectionIndex] = r, Tn(ut(yn(fn, e)), kt(r)), w = setTimeout(function () {
                            n && lt(t)
                        }, E.scrollingSpeed)
            ...
            function St(e, t) {
                ...
                if (null != n) {
                    ...
                    Et(n) === x || Ln(n, Xt) ? bt(l) : Re(n, function () {
                        bt(l)
                    })
                }
            }
            ...
            function Tt(e) {
                ...
                else if (E.autoScrolling && !E.scrollBar) Tn(d, {
                    top: -t + "px"
                }), g.test.top = -t + "px";
                else {
                    var n = Pe(t);
            ...
            function Ct() {
                ...
                n ? e && e.length < 20 && (console.warn("%c This website was made using fullPage.js slider. More info on the following website:", t), console.warn("%c https://alvarotrigo.com/fullPage/", t)) : (wn("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"), wn("error", "https://github.com/alvarotrigo/fullPage.js#options")), Ln(u, Ft) ? wn("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (E.continuousVertical && (E.loopTop || E.loopBottom) && (E.continuousVertical = !1, wn("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), !E.scrollOverflow || !E.scrollBar && E.autoScrolling || wn("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"), !E.continuousVertical || !E.scrollBar && E.autoScrolling || (E.continuousVertical = !1, wn("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), E.scrollOverflow && null == E.scrollOverflowHandler && (E.scrollOverflow = !1, wn("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")), Y.forEach(function (e) {
                    E[e] && wn("warn", "fullpage.js extensions require fullpage.extensions.min.js file instead of the usual fullpage.js. Requested: " + e)
